...
#_________________________________ model build ________________________________
...
#___________________ Structural and Phsysical Parameters ______________________
g = 9.81
deckweight = 25000
EI = 25000000000
fy = 355000
dt = 0.005
eqk = 'Matched_165-1.A.txt'
factor = 25
damp = 0.05
eqksteps = 6999
...
#_________________________________Materials ___________________________________
...
#_________________________________Recorder_____________________________________
...
#____________________________Analysis Details_________________________________ 
Tol = 1.0e-6
...
## Plotting the Time History RESULTS!!!$ pythonw -m ipykernel -f "$USERHOME/AppData/Roaming/jupyter/runtime/kernel-2744.json"
